...
class RoundHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, List<RoundResultDto>> roundResults =
    ...
    for (int i = 0; i < lastRound; i++) {
      if (!roundsWonPlayer.contains(i)) {
        roundResults['Your Team']!.add(RoundResultDto.createLostRound(
          i,
        ));
      }
      if (!roundsWonEnemy.contains(i)) {
        roundResults['Enemy Team']!.add(RoundResultDto.createLostRound(
          i,
        ));
      }
    }

    roundResults['Your Team']!.sort((a, b) => a.roundNum.compareTo(b.roundNum));
